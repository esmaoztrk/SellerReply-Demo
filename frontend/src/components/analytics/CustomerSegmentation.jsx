...
const customerSegmentationData = [
	...
	{ subject: "Harcama", A: 99, B: 100, fullMark: 150 },
	{ subject: "Sıklık", A: 85, B: 90, fullMark: 150 },
	{ subject: "Son Kullanım", A: 65, B: 85, fullMark: 150 },
];
...
const CustomerSegmentation = () => {
	return (
		...
		>
			<h2 className='text-xl font-semibold text-gray-100 mb-4'>Müşteri Segmentasyonu</h2>
