...
const overviewData = [
	{ name: "Gelir", value: "$1,234,567", change: 12.5, icon: DollarSign },
	{ name: "Kullanıcılar", value: "45,678", change: 8.3, icon: Users },
	{ name: "Siparişler", value: "9,876", change: -3.2, icon: ShoppingBag },
	{ name: "Görüntüleme", value: "1,234,567", change: 15.7, icon: Eye },
];
          ...
          '
            ...
            `}
					>
						...
						<span className='ml-2 text-sm text-gray-400'>vs önceki dönem</span>
					</div>
				</motion.div>
			))}
		</div>
